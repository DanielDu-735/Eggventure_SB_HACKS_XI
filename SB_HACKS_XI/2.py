...
# Load Images
egg_image = pygame.image.load('egg.png')  # Ensure this path is correct
egg_image = pygame.transform.scale(egg_image, (40, 40))  # Scale the egg image to the desired size
...
class Egg:
    ...
    def draw(self, screen):
        if self.invincible:
            ...
            screen.blit(egg_image, (self.x - egg_image.get_width() // 2, self.y - egg_image.get_height() // 2))
        else:
            screen.blit(egg_image, (self.x - egg_image.get_width() // 2, self.y - egg_image.get_height() // 2))
...
class Obstacle:
    ...
    def draw(self, screen):
        screen.blit(obstacle_image, (self.x + self.size // 2 - obstacle_image.get_width() // 2, 
                                     self.y + self.size // 2 - obstacle_image.get_height() // 2))
